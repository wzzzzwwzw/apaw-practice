...
class AlbumRepositoryIT {
    ...
    void testFindByDenomination() {
        ...
        MusicGenreEntity musicGenre1 = new MusicGenreEntity("reggaeton", "reggaeton music", 10, "Puerto Rico");
        MusicGenreEntity musicGenre2 = new MusicGenreEntity("rock", "rock music", 9, "United Kingdom");
        ...
        SongEntity song1 = new SongEntity("Una Locura", 3, false, 4.0, musicGenre1, Arrays.asList(artist1, artist2, artist3));
        SongEntity song2 = new SongEntity("El Vals del Obrero", 5, false, 4.0, musicGenre2, Collections.singletonList(artist4));
