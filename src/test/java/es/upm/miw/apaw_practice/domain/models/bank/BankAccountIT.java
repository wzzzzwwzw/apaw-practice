...
public class BankAccountIT {
    ...
    void testCreateBuilder(){
        BankAccount bankAccount=BankAccount.builder().numAccount("21323-3233-1234-1234").expiration(LocalDate.of(2031,3,12)).cvv(134).balance(new BigDecimal("1222000")).build();
