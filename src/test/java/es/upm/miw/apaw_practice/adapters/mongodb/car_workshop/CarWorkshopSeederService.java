...
public class CarWorkshopSeederService {
    ...
    public void seedDatabase() {
        ...
        CarComponentEntity[] carComponentEntities = {
                ...
                new CarComponentEntity(new CarComponent("Ambipur car fragance", new BigDecimal("1.0"), 10000))
        };
        ...
        CarToRepairEntity[] carToRepairEntities = {
                ...
                new CarToRepairEntity("1111BBB", "Skoda", "IDK", List.of(obdFaultEntities[0]))
        };
        ...
        InvoiceEntity[] invoiceEntities = {
                ...
                new InvoiceEntity(LocalDateTime.now(), new BigDecimal(1000), true, carToRepairEntities[4], List.of(carComponentEntities[5]))
        };
